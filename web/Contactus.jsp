...
<div class="container">
    ...
    <div class="row justify-content-md-center">
        <div class="col-lg-6 well ">
            ...
            <p><span class="glyphicon btn-lg glyphicon-envelope"></span>info@blackbox.com <br>
            <p><span class="glyphicon btn-lg glyphicon-user"></span>0323-4974774 <br>
            <p><span class="glyphicon btn-lg glyphicon-home"></span>Arfa Technology Park  <br>
